...
export default function Page(){return <GradeOfficialSection junior={[readingSet,grade78Reading2025]} grade9={[grade9Reading2022,grade9Reading2023,grade9Reading2024]}/>}
